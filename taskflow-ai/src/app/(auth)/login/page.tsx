...
import { GitBranch, Mail, Lock, Globe, Zap, ArrowLeft } from "lucide-react"
      ...
      >
        ...
        <div className="glass-dark rounded-3xl border border-white/10 p-8 shadow-2xl">
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-gray-400 text-sm mt-1">Ready to be productive today?</p>
          </div>

          <div className="space-y-4">
            <button 
              onClick={() => signIn("google", { callbackUrl: "/dashboard" })}
              className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl bg-white text-black font-bold hover:bg-gray-200 transition-all hover:scale-[1.02] active:scale-95"
            >
            ...
            <button 
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl bg-gray-900 text-white font-bold border border-white/10 hover:bg-gray-800 transition-all hover:scale-[1.02] active:scale-95"
            >
            ...
            <div className="relative py-4">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-[#0A0A0B] px-2 text-gray-500">Or email</span>
              </div>
            </div>
          ...
          <p className="mt-8 text-center text-sm text-gray-500">
            Don't have an account? <Link href="/register" className="text-indigo-400 hover:underline font-medium">Join TaskFlow AI</Link>
          </p>
        </div>
      </motion.div>
    </div>
